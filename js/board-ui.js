...
window.PIECE_SETS = {
    ...
    custom: { label: 'chessnut', theme: 'assets/pieces/custom/{piece}.svg' },
    custom: { label: '2', theme: 'assets/pieces/custom/{piece}.svg' },
    custom: { label: '3', theme: 'assets/pieces/custom/{piece}.svg' }
};
